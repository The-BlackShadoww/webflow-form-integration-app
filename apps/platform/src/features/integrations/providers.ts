...
export function findProviderForType(
...
export const providers: Provider[] = [
  // OAuth
  {
    ...
    name: "Notion",
    authMode: "oauth",
    description: "Append form submissions to a Notion database.",
    enabled: true,
    supportsApiKey: true,
  ...
  // Webhook URL — no creds needed
  {
    ...
    description: "POST form submissions to any URL.",
    enabled: true,
    typeAliases: ["WEBHOOKCONNECTION"],
  },
];
